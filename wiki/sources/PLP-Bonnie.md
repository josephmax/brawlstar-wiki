...
- 标题：Best build for Bonnie | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Bonnie | Power League Prodigy](https://powerleagueprodigy.com/bonnie)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/bonnie-2026-06-30.md]]
...
- 推荐 Gadget: `Sugar Rush`
- 推荐 Star Power: `Black Powder`
...
- countersThese: `El Primo`, `Frank`, `Jae-Yong`, `Meg`, `Poco`, `Jacky`, `Buzz`, `Kenji`
- counteredBy: `Edgar`, `Pearl`, `Leon`, `Angelo`, `Najia`, `Willow`, `Colette`, `Grom`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Bonnie|Bonnie]] 的 build、mode fit、matchup 候选提供竞技信号。
