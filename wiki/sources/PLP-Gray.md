...
- 标题：Best build for Gray | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Gray | Power League Prodigy](https://powerleagueprodigy.com/gray)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/gray-2026-06-30.md]]
...
- 推荐 Gadget: `Walking Cane`
- 推荐 Star Power: `Fake Injury`
...
- countersThese: `Sprout`, `Grom`, `Dynamike`, `Carl`, `Emz`, `Bo`, `Lou`, `Squeak`
- counteredBy: `Mr. P`, `Gus`, `Tara`, `Nani`, `Sam`, `R-T`, `Lola`, `Stu`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Gray|Gray]] 的 build、mode fit、matchup 候选提供竞技信号。
