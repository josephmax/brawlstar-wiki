...
- 标题：Best build for Lola | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Lola | Power League Prodigy](https://powerleagueprodigy.com/lola)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/lola.md]]
...
- 推荐 Gadget: `Freeze Frame`
- 推荐 Star Power: `Improvise`
- 推荐 Gears: Shield, Damage, Reload
- 推荐 Modes: Brawl Ball, Heist, Bounty
- Notes: PREFERENCE, 2 1 PRO
- Avoid: none observed

## Matchup 候选

- countersThese: `Bibi`, `Piper`, `Griff`, `Charlie`, `Bull`, `Byron`, `Shelly`, `Brock`
- counteredBy: `Penny`, `Willow`, `8-Bit`, `Barley`, `Sandy`, `Max`, `Dynamike`, `Bo`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Lola|Lola]] 的 build、mode fit、matchup 候选提供竞技信号。
