...
- 标题：Best build for Mico | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Mico | Power League Prodigy](https://powerleagueprodigy.com/mico)
- 读取日期：2026-06-29
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/mico-2026-06-29.md]]
...
- 推荐 Gadget: `Clipping Scream`
- 推荐 Star Power: `Record Smash`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Knockout, Heist
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Sprout`, `Ziggy`, `Piper`, `Spike`, `Mandy`, `Bo`, `Dynamike`, `Poco`
- counteredBy: `Colette`, `R-T`, `Chester`, `Bull`, `Sam`, `Doug`, `Trunk`, `Nita`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Mico|Mico]] 的 build、mode fit、matchup 候选提供竞技信号。
