...
- 读取日期：2026-07-11
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/brock.md]]
...
- countersThese: `8-Bit`, `Nita`, `Pam`, `Shelly`, `Mr. P`, `Hank`, `Spike`, `Emz`
- counteredBy: `Stu`, `Crow`, `Max`, `Cordelius`, `Leon`, `Mortis`, `Bibi`, `Edgar`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Brock|Brock]] 的 build、mode fit、matchup 候选提供竞技信号。
