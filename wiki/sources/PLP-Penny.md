...
- 标题：Best build for Penny | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Penny | Power League Prodigy](https://powerleagueprodigy.com/penny)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/penny-2026-06-30.md]]
...
- 推荐 Gadget: `Salty Barrel`
- 推荐 Star Power: `Master Blaster`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Gem Grab, Heist, Hot Zone
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Spike`, `Lola`, `Gene`, `Bea`, `Surge`, `Crow`, `Eve`, `Charlie`
- counteredBy: `Carl`, `Barley`, `Belle`, `Mr. P`, `Squeak`, `Sandy`, `Ollie`, `Poco`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Penny|Penny]] 的 build、mode fit、matchup 候选提供竞技信号。
