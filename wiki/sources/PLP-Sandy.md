...
- 标题：Best build for Sandy | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Sandy | Power League Prodigy](https://powerleagueprodigy.com/sandy)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/sandy-2026-06-30.md]]
...
- 推荐 Gadget: `Sweet Dreams`
- 推荐 Star Power: `Rude Sands`
- 推荐 Gears: Shield, Damage, Speed
...
- countersThese: `Jae-Yong`, `Piper`, `Nani`, `Gigi`, `Squeak`, `Sprout`, `Chuck`, `Mr. P`
- counteredBy: `Nita`, `Rosa`, `Damian`, `Crow`, `Larry & Lawrie`, `Emz`, `Mortis`, `Bo`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Sandy|Sandy]] 的 build、mode fit、matchup 候选提供竞技信号。
