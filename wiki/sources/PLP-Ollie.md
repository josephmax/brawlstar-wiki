...
- 标题：Best build for Ollie | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Ollie | Power League Prodigy](https://powerleagueprodigy.com/ollie)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/ollie-2026-06-30.md]]
...
- 推荐 Gadget: `Regulate`
- 推荐 Star Power: `Renegade`
- 推荐 Gears: Shield, Damage, Health
- 推荐 Modes: Bounty, Knockout
- Notes: GADGET 1 CLOSED MAP
- Avoid: MEEPLE

## Matchup 候选

- countersThese: `Alli`, `Mico`, `Lola`, `Chuck`, `Frank`, `El Primo`, `Shade`, `Bea`
- counteredBy: `Poco`, `Meeple`, `Najia`, `Colette`, `Sandy`, `Fang`, `Edgar`, `Rosa`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Ollie|Ollie]] 的 build、mode fit、matchup 候选提供竞技信号。
