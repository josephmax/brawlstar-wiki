...
- 标题：Best build for Najia | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Najia | Power League Prodigy](https://powerleagueprodigy.com/najia)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/najia.md]]
...
- 推荐 Gadget: `Poison Puddles`
- 推荐 Star Power: `Poisonous Protector`
...
- countersThese: `Dynamike`, `Meg`, `Gale`, `Mandy`, `Lou`, `R-T`, `Piper`, `Jae-Yong`
- counteredBy: `Poco`, `Eve`, `Edgar`, `Sam`, `Damian`, `Melodie`, `Chuck`, `Lola`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Najia|Najia]] 的 build、mode fit、matchup 候选提供竞技信号。
