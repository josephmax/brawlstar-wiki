...
- 标题：Best build for Bo | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Bo | Power League Prodigy](https://powerleagueprodigy.com/bo)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/bo-2026-06-30.md]]
...
- 推荐 Gadget: `Super Totem`
- 推荐 Star Power: `Snare A Bear`
- 推荐 Gears: Vision, Shield, Damage
- 推荐 Modes: Gem Grab, Hot Zone, Heist
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Gray`, `Dynamike`, `Mandy`, `Frank`, `Jae-Yong`, `Gene`, `Gale`, `Squeak`
- counteredBy: `Sam`, `Mico`, `Damian`, `Kaze`, `Mina`, `Melodie`, `Eve`, `Mortis`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Bo|Bo]] 的 build、mode fit、matchup 候选提供竞技信号。
