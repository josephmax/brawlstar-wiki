...
- 上游 raw：[[../../raw/sources/fandom/heroes/damian-2026-06-30-v2.md]]
...
- 稀有度: Mythic
- 官方定位: Tank
- 移动速度: 770 (Fast)<br>1001 (when using charged attack)<br>924 (with Hypercharge)
- 生命值: 5600
- 攻击距离: 2.67 (Short)
- 装填: 1.2 seconds (Fast)
- 普攻数值: 700
...
- `Damian` 的 Fandom 页面已有 direct raw，可作为稳定机制来源。
- 后续升级 [[entities/brawlers/Damian|Damian]] 时，应优先从本 raw 抽取机制事实，再与 [[sources/PLP-Damian|PLP 竞技信号]] 分层合并。
