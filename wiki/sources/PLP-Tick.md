...
- 标题：Best build for Tick | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Tick | Power League Prodigy](https://powerleagueprodigy.com/tick)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/tick-2026-06-30.md]]
...
- 推荐 Gadget: `Last Hurrah`
- 推荐 Star Power: `Well Oiled`
- 推荐 Gears: Thicc Head, Vision, Shield
...
- countersThese: `Poco`, `Chuck`, `Meg`, `Lola`, `Berry`, `Lou`, `Jacky`, `Surge`
- counteredBy: `Starr Nova`, `Damian`, `Edgar`, `Mortis`, `Pearl`, `Mina`, `Leon`, `Brock`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Tick|Tick]] 的 build、mode fit、matchup 候选提供竞技信号。
