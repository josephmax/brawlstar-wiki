...
- 标题：Best build for Belle | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Belle | Power League Prodigy](https://powerleagueprodigy.com/belle)
- 读取日期：2026-06-29
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/belle-2026-06-29.md]]
...
- 推荐 Gadget: `Nest Egg`
- 推荐 Star Power: `Positive Feedback`
...
- countersThese: `El Primo`, `Jacky`, `Shelly`, `Buzz`, `Hank`, `Stu`, `Griff`, `Frank`
- counteredBy: `Sprout`, `Chuck`, `Rosa`, `Barley`, `Willow`, `Bibi`, `Larry & Lawrie`, `Sandy`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Belle|Belle]] 的 build、mode fit、matchup 候选提供竞技信号。
