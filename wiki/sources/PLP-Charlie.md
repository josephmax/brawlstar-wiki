...
- 标题：Best build for Charlie | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Charlie | Power League Prodigy](https://powerleagueprodigy.com/charlie)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/charlie-2026-06-30.md]]
...
- countersThese: `Chuck`, `Bolt`, `Shelly`, `Surge`, `Meg`, `Clancy`, `Glowy`, `Fang`
- counteredBy: `Sprout`, `Barley`, `Larry & Lawrie`, `8-Bit`, `Damian`, `Lola`, `Poco`, `Ollie`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Charlie|Charlie]] 的 build、mode fit、matchup 候选提供竞技信号。
