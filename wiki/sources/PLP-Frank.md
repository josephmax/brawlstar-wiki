...
- 标题：Best build for Frank | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Frank | Power League Prodigy](https://powerleagueprodigy.com/frank)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/frank-2026-06-30.md]]
...
- 推荐 Gadget: `Irresistible Attraction`
- 推荐 Star Power: `Power Grab`
...
- countersThese: `Squeak`, `Grom`, `Sprout`, `Gene`, `Penny`, `Charlie`, `Cordelius`, `Ash`
- counteredBy: `Colette`, `Emz`, `Lou`, `Shelly`, `El Primo`, `Maisie`, `Surge`, `Fang`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Frank|Frank]] 的 build、mode fit、matchup 候选提供竞技信号。
