...
- 读取日期：2026-08-10
- Fandom 页面最后编辑：2026-08-04T09:15:24Z
- 分类：Brawlers / Fandom hero page
- 上游 raw：[[../../raw/sources/fandom/heroes/griff-2026-08-10.md]]
...
- 生命值: 3700
- 攻击距离: 8.33 (Long)
- 装填: 1.6 seconds (Normal)<br>1.7 seconds (while Hyper Buffie is active)
- 普攻数值: 280
- Super 距离: 9 (Long)
- Super 数值: 360
...
- `Griff` 的 Fandom 页面已有 direct raw，可作为稳定机制来源。
- 后续升级 [[entities/brawlers/Griff|Griff]] 时，应优先从本 raw 抽取机制事实，再与 [[sources/PLP-Griff|PLP 竞技信号]] 分层合并。
