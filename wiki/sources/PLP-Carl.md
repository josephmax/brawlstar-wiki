...
- 标题：Best build for Carl | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Carl | Power League Prodigy](https://powerleagueprodigy.com/carl)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/carl-2026-06-30.md]]
...
- 推荐 Gadget: `Heat Ejector`
- 推荐 Star Power: `Protective Pirouette`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Gem Grab, Brawl Ball, Heist, Bounty
- Notes: GADGET 1 HEIST
- Avoid: none observed

## Matchup 候选

- countersThese: `Squeak`, `Sprout`, `Ziggy`, `Poco`, `Mandy`, `Jae-Yong`, `Piper`, `Brock`
- counteredBy: `Bolt`, `Gale`, `Damian`, `Bibi`, `Edgar`, `Trunk`, `Shade`, `Bull`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Carl|Carl]] 的 build、mode fit、matchup 候选提供竞技信号。
