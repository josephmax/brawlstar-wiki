...
- 上游 raw：[[../../raw/sources/fandom/heroes/gus-2026-06-30-v2.md]]
...
- `Gus` 的 Fandom 页面已有 direct raw，可作为稳定机制来源。
- 后续升级 [[entities/brawlers/Gus|Gus]] 时，应优先从本 raw 抽取机制事实，再与 [[sources/PLP-Gus|PLP 竞技信号]] 分层合并。

## 关联页面

- [[entities/brawlers/Gus|Gus]]
- [[sources/PLP-Gus|PLP 来源摘要: Gus]]
