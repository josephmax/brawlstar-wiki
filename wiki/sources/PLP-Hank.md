...
- 标题：Best build for Hank | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Hank | Power League Prodigy](https://powerleagueprodigy.com/hank)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/hank-2026-06-30.md]]
...
- 推荐 Gadget: `Barricade`
- 推荐 Star Power: `Its Gonna Blow`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Brawl Ball, Hot Zone, Gem Grab
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Jae-Yong`, `Poco`, `Sprout`, `Gigi`, `Squeak`, `Piper`, `Cordelius`, `Mr. P`
- counteredBy: `Trunk`, `Rosa`, `Damian`, `Ash`, `Sandy`, `Tara`, `Frank`, `Bibi`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Hank|Hank]] 的 build、mode fit、matchup 候选提供竞技信号。
