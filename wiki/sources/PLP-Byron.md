...
- 标题：Best build for Byron | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Byron | Power League Prodigy](https://powerleagueprodigy.com/byron)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/byron-2026-06-30.md]]
...
- 推荐 Gadget: `Booster Shots`
- 推荐 Star Power: `Malaise`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Heist, Hot Zone, Bounty, Knockout
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Frank`, `Jacky`, `Dynamike`, `El Primo`, `Buzz`, `Max`, `R-T`, `Gale`
- counteredBy: `Poco`, `Willow`, `Rosa`, `Barley`, `Chuck`, `Sandy`, `Sprout`, `Lola`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Byron|Byron]] 的 build、mode fit、matchup 候选提供竞技信号。
