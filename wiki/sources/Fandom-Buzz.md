...
- 上游 raw：[[../../raw/sources/fandom/heroes/buzz-2026-06-30-v2.md]]
...
- 稀有度: Mythic
- 官方定位: Assassin
- 移动速度: 770 (Fast)<br>924 (with Hypercharge)<br>4500 (with Super)
- 生命值: 5000
- 攻击距离: 2.67 (Short)
...
- `Buzz` 的 Fandom 页面已有 direct raw，可作为稳定机制来源。
- 后续升级 [[entities/brawlers/Buzz|Buzz]] 时，应优先从本 raw 抽取机制事实，再与 [[sources/PLP-Buzz|PLP 竞技信号]] 分层合并。
