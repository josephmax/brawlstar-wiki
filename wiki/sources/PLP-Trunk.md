...
- 标题：Best build for Trunk | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Trunk | Power League Prodigy](https://powerleagueprodigy.com/trunk)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/trunk.md]]
...
- 推荐 Gadget: `Worker Ants`
- 推荐 Star Power: `New Insect Overlords`
...
- countersThese: `Shade`, `Sprout`, `Jae-Yong`, `Squeak`, `Mico`, `Nani`, `Piper`, `Mandy`
- counteredBy: `Otis`, `Clancy`, `Crow`, `Damian`, `Colette`, `Nita`, `Doug`, `Juju`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Trunk|Trunk]] 的 build、mode fit、matchup 候选提供竞技信号。
