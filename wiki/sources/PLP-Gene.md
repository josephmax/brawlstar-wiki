...
- 标题：Best build for Gene | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Gene | Power League Prodigy](https://powerleagueprodigy.com/gene)
- 读取日期：2026-06-29
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/gene-2026-06-29.md]]
...
- 推荐 Gadget: `Vengeful Spirits`
- 推荐 Star Power: `Magic Puffs`
- 推荐 Gears: Shield, Vision, Talk to the Hand
...
- countersThese: `Fang`, `Emz`, `Squeak`, `Barley`, `Carl`, `Sprout`, `Rico`, `Buzz`
- counteredBy: `Mico`, `Bea`, `Stu`, `Eve`, `Mr. P`, `Brock`, `Piper`, `Mandy`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Gene|Gene]] 的 build、mode fit、matchup 候选提供竞技信号。
