...
- 上游 raw：[[../../raw/sources/fandom/heroes/sprout-2026-06-30-v2.md]]
...
- `Sprout` 的 Fandom 页面已有 direct raw，可作为稳定机制来源。
- 后续升级 [[entities/brawlers/Sprout|Sprout]] 时，应优先从本 raw 抽取机制事实，再与 [[sources/PLP-Sprout|PLP 竞技信号]] 分层合并。
