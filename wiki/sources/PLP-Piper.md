...
- 标题：Best build for Piper | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Piper | Power League Prodigy](https://powerleagueprodigy.com/piper)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/piper-2026-06-30.md]]
...
- 推荐 Gadget: `Auto Aimer`
- 推荐 Star Power: `Snappy Sniping`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Bounty, Heist
- Notes: GADGET 1 AGGRO
- Avoid: none observed

## Matchup 候选

- countersThese: `Brock`, `Mandy`, `Belle`, `Byron`, `Gene`, `Bea`, `Bonnie`, `Colt`
- counteredBy: `Nani`, `Angelo`, `Mr. P`, `Tick`, `R-T`, `Max`, `Mortis`, `Gray`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Piper|Piper]] 的 build、mode fit、matchup 候选提供竞技信号。
