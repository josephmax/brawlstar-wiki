...
- 标题：Best build for Stu | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Stu | Power League Prodigy](https://powerleagueprodigy.com/stu)
- 读取日期：2026-06-29
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/stu-2026-06-29.md]]
...
- 推荐 Gadget: `Speed Zone`
- 推荐 Star Power: `Zero Drag`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Gem Grab, Brawl Ball, Hot Zone
- Notes: GADGET 2 IF WALLBREAK IS GOOD, SP 1 SNIPERS
- Avoid: none observed

## Matchup 候选

- countersThese: `Sprout`, `Dynamike`, `Piper`, `Tick`, `Ziggy`, `Gigi`, `Mandy`, `Squeak`
- counteredBy: `Rosa`, `Damian`, `Ash`, `Poco`, `8-Bit`, `Ollie`, `Frank`, `Nita`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Stu|Stu]] 的 build、mode fit、matchup 候选提供竞技信号。
