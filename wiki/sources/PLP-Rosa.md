...
- 标题：Best build for Rosa | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Rosa | Power League Prodigy](https://powerleagueprodigy.com/rosa)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/rosa-2026-06-30.md]]
...
- 推荐 Gadget: `Grow Light`
- 推荐 Star Power: `Plant Life`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Gem Grab, Brawl Ball, Hot Zone
- Notes: 1 1 OR 2 2 PREFERENCE, 2 2 PRO
- Avoid: none observed

## Matchup 候选

- countersThese: `Bolt`, `Jae-Yong`, `Sprout`, `Squeak`, `Poco`, `Gus`, `Piper`, `Mandy`
- counteredBy: `Otis`, `Clancy`, `Damian`, `Griff`, `Bibi`, `Nita`, `Crow`, `Colette`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Rosa|Rosa]] 的 build、mode fit、matchup 候选提供竞技信号。
