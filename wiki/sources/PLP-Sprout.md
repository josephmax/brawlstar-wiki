...
- 标题：Best build for Sprout | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Sprout | Power League Prodigy](https://powerleagueprodigy.com/sprout)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/sprout-2026-06-30.md]]
...
- 推荐 Gadget: `Transplant`
- 推荐 Star Power: `Overgrowth`
- 推荐 Gears: Super Charge, Shield, Damage, Gadget Cooldown
- 推荐 Modes: Knockout
- Notes: none observed
- Avoid: none observed
...
- countersThese: `Belle`, `Bea`, `Spike`, `Penny`, `Gus`, `Amber`, `Tara`, `Eve`
- counteredBy: `Mortis`, `Fang`, `Carl`, `Gray`, `Sam`, `Ash`, `Darryl`, `Edgar`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Sprout|Sprout]] 的 build、mode fit、matchup 候选提供竞技信号。
