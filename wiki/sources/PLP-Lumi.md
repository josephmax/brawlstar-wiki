...
- 标题：Best build for Lumi | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Lumi | Power League Prodigy](https://powerleagueprodigy.com/lumi)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/lumi-2026-06-30.md]]
...
- 推荐 Gadget: `Grim And Frostbitten`
- 推荐 Star Power: `Half-Time`
...
- countersThese: `Meg`, `Mr. P`, `Nani`, `Glowy`, `Sprout`, `Piper`, `Pam`, `Gene`
- counteredBy: `Bolt`, `Damian`, `Bea`, `Barley`, `Bo`, `Janet`, `Crow`, `Finx`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Lumi|Lumi]] 的 build、mode fit、matchup 候选提供竞技信号。
