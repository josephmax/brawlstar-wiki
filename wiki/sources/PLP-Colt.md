...
- 标题：Best build for Colt | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Colt | Power League Prodigy](https://powerleagueprodigy.com/colt)
- 读取日期：2026-06-29
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/colt-2026-06-29.md]]
...
- 推荐 Gadget: `Speedloader`
- 推荐 Star Power: `Slick Boots`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Heist, Brawl Ball, Gem Grab
- Notes: PREFERENCE, SP 1 PRO
- Avoid: none observed

## Matchup 候选

- countersThese: `R-T`, `Sprout`, `Mandy`, `Tick`, `Ziggy`, `El Primo`, `Piper`, `Brock`
- counteredBy: `Angelo`, `Damian`, `Moe`, `Bibi`, `Meeple`, `Stu`, `Starr Nova`, `Chester`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Colt|Colt]] 的 build、mode fit、matchup 候选提供竞技信号。
