...
- 标题：Best build for Griff | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Griff | Power League Prodigy](https://powerleagueprodigy.com/griff)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/griff-2026-06-30.md]]
...
- 推荐 Gadget: `Piggy Bank`
- 推荐 Star Power: `Business Resilience`
...
- countersThese: `Nita`, `Poco`, `Colette`, `Janet`, `Sam`, `Rosa`, `Darryl`, `Bull`
- counteredBy: `Surge`, `Spike`, `Bo`, `Buzz`, `Colt`, `Fang`, `Stu`, `Crow`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Griff|Griff]] 的 build、mode fit、matchup 候选提供竞技信号。
