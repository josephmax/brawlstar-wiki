...
- 标题：Best build for R-T | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[R-T | Power League Prodigy](https://powerleagueprodigy.com/rt)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/rt-2026-06-30.md]]
...
- 推荐 Gadget: `Out Of Line`
- 推荐 Star Power: `Quick Maths`
- 推荐 Gears: Shield, Damage, Health
- 推荐 Modes: Bounty, Knockout
- Notes: GADGET 1 SP 2 AGGRO
- Avoid: none observed

## Matchup 候选

- countersThese: `Mico`, `El Primo`, `Melodie`, `Sam`, `Buzz`, `Hank`, `Lily`, `Kaze`
- counteredBy: `Najia`, `Grom`, `Colette`, `Sandy`, `Leon`, `Pierce`, `Mina`, `Mortis`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/R-T|R-T]] 的 build、mode fit、matchup 候选提供竞技信号。
