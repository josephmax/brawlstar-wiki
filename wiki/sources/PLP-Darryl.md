...
- 标题：Best build for Darryl | Brawl Stars loadout, gears & counters | PL Prodigy
- 来源：[Darryl | Power League Prodigy](https://powerleagueprodigy.com/darryl)
- 读取日期：2026-06-30
- 上游 raw：[[../../raw/sources/pl-prodigy/brawlers/darryl.md]]
...
- 推荐 Gadget: `Tar Barrel`
- 推荐 Star Power: `Steel Hoops`
- 推荐 Gears: Shield, Damage
- 推荐 Modes: Heist, Knockout
- Notes: none observed
- Avoid: none observed

## Matchup 候选

- countersThese: `Mr. P`, `Jessie`, `Alli`, `Sprout`, `Piper`, `Jae-Yong`, `Ziggy`, `Poco`
- counteredBy: `Chester`, `Bull`, `8-Bit`, `Willow`, `Sandy`, `Colette`, `Nita`, `Bibi`

这些 matchup 只作为 `conditional_matchup_seed`，不能写成无条件克制。进入 BP 模型前必须补机制、地图条件、build 条件、失效条件和 BP 用途。

## 与本地 wiki 的意义

- 本页为 [[entities/brawlers/Darryl|Darryl]] 的 build、mode fit、matchup 候选提供竞技信号。
