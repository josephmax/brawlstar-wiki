...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "mid; fandom_attack_range=6.33 (Normal)"
    ...
    sustained_dps: "reload_signal_from_fandom=2.4 seconds (Very Slow)<br>1.6 seconds (With Floor is Fine; Normal)"
