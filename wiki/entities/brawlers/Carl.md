...
```json
{"combat_breakpoint_profile":{"schema":"brawler_breakpoint_profile.v1","brawler":"Carl","target_states":[{"id":"body","entity_class":"brawler_body","roster_target":true,"health":{"amount":4200,"at_power_level":1,"scaling":"standard"},"source_ref":"[[sources/Fandom-Carl|Fandom-Carl]]"}],"damage_packets":[{"id":"main.one_impact","ability_kind":"main_attack","packet_unit":"impact","delivery_variant":"impact","repeat_model":"identical","damage":{"amount":820,"at_power_level":1,"scaling":"standard"},"active_when":"去程或回程的一次命中；完整 ammo 双命中不自动假设","source_conflict_status":"none","source_ref":"[[sources/Fandom-Carl|Fandom-Carl]]"}],"defense_modifiers":[]}}
```
