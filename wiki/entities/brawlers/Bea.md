...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    sustained_dps: "reload_signal_from_fandom=0.9 seconds (Very Fast)"
    objective_damage: "heist_candidate_from_plp_modes=False"
    mobility: "mobility_or_speed_tool_text_present"
    survivability: "fandom_health=2800; low_health_failure_check; self_or_team_sustain_text_present"
