...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "very_long_or_long; fandom_attack_range=6.33 (Normal)<br>9 (in bushes; Long)<br>9 (with Voodoo Chile; Long)"
    ...
    sustained_dps: "reload_signal_from_fandom=1.6 seconds (Normal)<br>2 seconds (while Voodoo Chile is active)"
