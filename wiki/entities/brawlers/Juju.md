...
Juju 的 BP 价值来自“站位所在地形改变能力”。站在地面时伤害提高，站在草里射程提升到长程，站在水上攻击附带 3 秒 slow；她本身可在水上移动，`Elementalist` 又按地形提供护盾、隐身或水上加速。Super 召唤 Gris-Gris，可在水上移动并追击敌人，`Guarded Gris-Gris` 给召唤物额外护盾。BP 中必须把 Juju 的价值绑定到具体地形：水域如果不连接目标路线，就只是移动噪声；草丛如果被清空，长射程和隐身价值会下降；地面高伤害则要求她能安全站位。
...
bp_brawler_profile:
  ...
  source_quality:
    fandom: "[[sources/Fandom-Juju|Fandom-Juju]]"
  ...
  build_switches:
    - build: "Elementalist / Guarded Gris-Gris / Shield, Damage"
      ...
      changes_capabilities:
        ...
        - "Guarded Gris-Gris 让下一次 Super 带衰减护盾，提高召唤物吃弹和压线能力"
  ...
  map_feature_hooks:
    ...
    - map_feature_type: knockout_bounty_gris_gris_wall_control
      uses_feature_by: "投掷弧线和 Guarded Gris-Gris 在墙边/回合末制造 ammo tax 和追击压力"
  ...
  failure_modes:
    ...
    - id: gris_gris_deleted_or_misdirected
      ...
      mitigation: "靠近目标或墙边部署，Guarded Gris-Gris 只视为 ammo tax 不视为必杀"
