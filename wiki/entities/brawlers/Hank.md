...
- PLP 推荐模式候选：Brawl Ball, Hot Zone, Gem Grab
...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "short; fandom_attack_range=1.67 (min. range)<br> 3.33 (max. range)"
    ...
    sustained_dps: "reload_signal_from_fandom=0.25 seconds (Very Fast)"
    ...
    survivability: "fandom_health=5200; high_health_body_presence_candidate; self_or_team_sustain_text_present"
  ...
  build_switches:
    - build: "Barricade / Its Gonna Blow / Shield, Damage"
