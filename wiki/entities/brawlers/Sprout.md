...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    burst: "medium; Power 11 Seed Bomb 单次爆炸 2200，未带盾/减伤的基础血量 <=6600 为三发线；Overgrowth 和 Hypercharge Thorns 能提高区域伤害但不等于稳定秒杀"
    sustained_dps: medium; 1.5 秒装填让墙后与窄口的投掷密度提高，收益仍主要来自安全位置和路线税累积
  ...
  map_feature_hooks:
    - map_feature_type: thrower_pocket_and_choke_lock
      uses_feature_by: 从墙后以 1.5 秒装填持续投掷，并用 Hedge 封窄口，让敌方只能绕路或聚集通过
    ...
    - map_feature_type: brawl_ball_goal_block_and_route_denial
      uses_feature_by: Hedge 临时挡住球路、门前通道或持球推进线，Transplant 支持连续防守；更紧密的 Seed Bomb 循环负责惩罚被迫绕行者
    ...
    - map_feature_type: gem_mine_entrance_block
      uses_feature_by: Hedge 阻断中心入口或 carrier 追击路线，1.5 秒装填的 Seed Bomb 继续压入口
...
```json
{"combat_breakpoint_profile":{"schema":"brawler_breakpoint_profile.v1","brawler":"Sprout","target_states":[{"id":"body","entity_class":"brawler_body","roster_target":true,"health":{"amount":3200,"at_power_level":1,"scaling":"standard"},"source_ref":"[[sources/Fandom-Sprout|Fandom-Sprout]]"}],"damage_packets":[{"id":"main.explosion","ability_kind":"main_attack","packet_unit":"explosion","delivery_variant":"impact","repeat_model":"identical","damage":{"amount":1100,"at_power_level":1,"scaling":"standard"},"active_when":"Seed Bomb 单次爆炸命中","source_conflict_status":"none","source_ref":"[[sources/Fandom-Sprout|Fandom-Sprout]]"}],"defense_modifiers":[]}}
```
