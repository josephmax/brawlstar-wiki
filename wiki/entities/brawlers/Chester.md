...
bp_brawler_profile:
  ...
  source_quality:
    fandom: "[[sources/Fandom-Chester|Fandom-Chester]]"
  ...
  capability_vector:
    ...
    sustained_dps: medium; Candy Beans 可能提供短时间 reload/damage/speed/heal，但效果随机
  ...
  build_switches:
    - build: "Candy Beans / Single Bellomania / Speed, Damage"
      ...
      changes_capabilities:
        - "Candy Beans 提供 5 秒随机 buff，可能是伤害、回血、装填或速度，提升短窗上限但不可指定"
  ...
  failure_modes:
    ...
    - id: candy_beans_rng_window
      ...
      mitigation: "把 Candy Beans 当上限补充，不把它写成确定的开团能力"
