...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "very_long_or_long; fandom_attack_range=7.67 (Long)<br>15.33 (with Windup; Very Long)"
    ...
    sustained_dps: "reload_signal_from_fandom=2.1 seconds (Slow)"
