...
- 1.8 秒装填仍要求 Super 前保存弹药，但拉人前补回三发的空窗较短。
...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    sustained_dps: medium_conditional; 1.8 秒装填缩短持续换血与回弹窗口，但三弹药必须为 Gravity 后续保留
  ...
  failure_modes:
    - id: no_super_low_threat_window
      ...
      exposed_by: Fandom 1.8 秒装填与 Super 依赖
      mitigation: 较快装填缩短无威胁窗口，但仍需队友控线充 Super，并在开团前保留足够弹药
