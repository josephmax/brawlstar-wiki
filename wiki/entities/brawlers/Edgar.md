...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "short; fandom_attack_range=2 (Short)<br>4 (additional projectiles; with Hyper Buffie)"
    ...
    sustained_dps: "reload_signal_from_fandom=0.7 seconds (Very Fast)<br>0.467 seconds (with Hypercharge)"
  ...
  build_switches:
    - build: "Lets Fly / Hard Landing / Shield, Damage"
