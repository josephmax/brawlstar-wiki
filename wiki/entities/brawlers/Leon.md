...
bp_brawler_profile:
  ...
  source_quality:
    fandom: "[[sources/Fandom-Leon|Fandom-Leon]] direct_raw_capture_2026-06-30-v2"
  ...
  capability_vector:
    ...
    survivability: "中等偏条件；Invisiheal 可用 Super 恢复，Lollipop Drop 可给短暂隐蔽空间"
    ...
    team_support: "条件性；Lollipop Drop 让队友在范围内隐形"
    spawnable_or_pet: "Clone Projector 产生可骗弹/探路的 clone"
    crowd_control: "无硬控"
    terrain_creation: "Lollipop Drop 创建隐身区域锚点"
  ...
  build_switches:
    - build: "Lollipop Drop / Smoke Trails / Shield + Damage"
      ...
      changes_capabilities:
        - "Lollipop Drop 给我方小范围隐身锚点，可保护长线、偷球或制造侧路不确定性"
  ...
  map_feature_hooks:
    - id: "bush_and_lollipop_information_gap"
      ...
      active_when: "敌方缺稳定探草、召唤物或范围扫点，且 Leon 能先用远端蹭出 Super"
      fails_if: "草被烧/扫掉，敌方有 Tara/Nita/Penny/Sandy 类持续探点，或目标可抱团保护"
