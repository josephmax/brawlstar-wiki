...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    survivability: "medium_with_sword_lifesteal; 3700 HP，剑形态命中自疗 30% 伤害"
    ...
    team_support: "medium_with_mystical; 普通攻击命中队友按伤害 30% 治疗"
  ...
  build_switches:
    - build: "Floaty Time / Mystical Starr Technique / Shield, Damage"
      ...
      changes_capabilities:
        ...
        - "Mystical Starr Technique 让普通攻击治疗队友 30% 伤害，并少量充 Super"
