...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    burst: "medium_high_in_sword_form; 剑形态瞬时宽弧命中，Power Level 变体可叠伤害"
    ...
    survivability: "medium_with_sword_lifesteal; 4000 HP，剑形态命中自疗 30% 伤害"
    ...
    team_support: "medium_with_mystical; 普通攻击命中队友按伤害 40% 治疗"
  ...
  build_switches:
    - build: "Floaty Time / Mystical Starr Technique / Shield, Damage"
      ...
      changes_capabilities:
        ...
        - "Mystical Starr Technique 让普通攻击治疗队友 40% 伤害，并少量充 Super"
  ...
  failure_modes:
    ...
    - id: "sword_form_not_crowd_dive"
      ...
      mitigation: "用她骚扰、收割或扰乱后排，队友提供 burst/控制"
