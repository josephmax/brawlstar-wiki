...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    burst: "high_after_star_launcher; Clyde 在 Power 11 单发 2440，未带盾/减伤的基础血量 <=4880 为两发线、<=7320 为三发线；跳入后还有落地伤害 + 三发满 ammo 近身爆发"
    ...
    "target_states": [
      {
        ...
        "source_ref": "[[sources/Fandom-Bonnie|Fandom-Bonnie]]"
      },
      {
        "id": "bonnie",
        "entity_class": "brawler_alternate_form",
        "roster_target": false,
        "health": {"amount": 3100, "at_power_level": 1, "scaling": "standard"},
        "state_rule": "独立形态血池，不与 Clyde 相加",
        "source_ref": "[[sources/Fandom-Bonnie|Fandom-Bonnie]]"
      }
    ],
    "damage_packets": [
      {
        "id": "main.clyde_impact",
        "ability_kind": "main_attack",
        "form": "clyde",
        "packet_unit": "impact",
        "delivery_variant": "impact",
        "repeat_model": "identical",
        "damage": {"amount": 1220, "at_power_level": 1, "scaling": "standard"},
        "active_when": "Clyde 形态单发命中",
