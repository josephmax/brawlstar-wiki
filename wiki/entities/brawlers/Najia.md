...
bp_brawler_profile:
  ...
  source_quality:
    fandom: "[[sources/Fandom-Najia|Fandom-Najia]]"
  ...
  capability_vector:
    ...
    area_control: high_with_poison_puddles_and_super_snakes
    ...
    spawnable_or_pet: snake_spawn_from_super_or_death_synergy
