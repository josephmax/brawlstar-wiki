...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    burst: "high_at_max_range; Power 11 满距离单发 3600，未带盾/减伤的基础血量 <=7200 为两发线、<=10800 为三发线；距离缩短、治疗或护盾会使该断点失效"
  ...
  conditional_matchups:
    - target: ["Brock", "Mandy", "Belle", "Byron"]
    ...
    "target_states": [
      {
        ...
        "source_ref": "[[sources/Fandom-Piper|Fandom-Piper]]"
      }
    ],
    "damage_packets": [
      {
        "id": "main.max_range_impact",
        "ability_kind": "main_attack",
        "packet_unit": "impact",
        "delivery_variant": "max_range",
        "repeat_model": "identical",
        "damage": {"amount": 1800, "at_power_level": 1, "scaling": "standard"},
        "active_when": "普攻在达到最大伤害的远距离命中；中间距离连续缩放不使用本包",
        "excluded_modifiers": ["ambush", "damage_gear", "hypercharge", "external_damage_buff"],
