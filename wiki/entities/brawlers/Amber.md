...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    sustained_dps: "reload_signal_from_fandom=0.22 seconds (8.8 seconds max; Very Fast)<br>0.187 seconds (7.48 seconds max; with Reload Gear)<br>0.146 seconds (5.86 seconds max; with Scorchin' Siphon)<br>0.124 seconds (4.96 seconds max; with Scorchin' Siphon and Reload Gear)"
