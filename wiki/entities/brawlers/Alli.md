...
bp_brawler_profile:
  ...
  capability_vector:
    effective_range: "short; fandom_attack_range=2.33 (dash; Short)<br>3.33 (jump; Short)<br>2.67 (dash; while enraged)<br> 4 (jump; while enraged)"
    ...
    sustained_dps: "reload_signal_from_fandom=2.1 seconds (dash; Slow)<br>2.8 seconds (jump; Very Slow)<br>1.68 seconds (dash; with You Better Run, You Better Take Cover)<br>2.24 seconds (jump; with You Better Run, You Better Take Cover)"
