...
bp_brawler_profile:
  ...
  capability_vector:
    ...
    sustained_dps: "reload_signal_from_fandom=1.7 seconds (Normal)<br> 1.417 seconds (with Rule Bending)<br>2 seconds (while Mansions of Meeple is active)<br>1.667 seconds (with Rule Bending and while Mansions of Meeple is active)"
